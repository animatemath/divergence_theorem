...
class ShuffleThroughAllSequences(Scene):
    ...
    def construct(self):
        ...
        left_idle_part = CoinSequence((self.nb_coins - nb_relevant_coins) * ["H"],
        ...
        for i in range(nb_cycles):
            ...
            coin_seq = CoinSequence(seq2,
                radius = self.coin_size * 0.5,
                spacing = self.coin_spacing)
            coin_seq.next_to(left_idle_part, RIGHT, buff = self.coin_spacing - self.coin_size)
